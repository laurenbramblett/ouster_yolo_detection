...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'example_ouster_data.pcap', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--metadata-path', type=str, default=ROOT / 'example_ouster_data.json', help='metadata path')
